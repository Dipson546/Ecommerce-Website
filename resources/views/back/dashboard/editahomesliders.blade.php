            ...
            <div class="row">
                <div class="col-9">
                    ...
                    <div class="content-header">
                        <h2 class="content-title">Chnage Your Home Slider</h2>

                        <form action="{{ route('back.home_slider.update',[$home_slider->id]) }}" method="post"
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Type here"
                                    ...
                                    name="title" value="{{ $sliders->title }}">
                                @error('title')
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div>
                                 ...
                                 <div class="row">
                                @foreach ($sliders->image_path as  $image)
                                <div class="col-3">

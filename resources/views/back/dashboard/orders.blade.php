                                ...
                                <tbody>
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    @foreach ($order->order_details as $detail)
                                                        <li>{{ $detail->qty }} x {{ $detail->product->name ?? 'null' }}
                                                            @if ($detail->product)
                                                                {{ $detail->product->name }}
                                                                @endif 
                                            ...
                                            <td>
                                                <form action="{{ route('back.orders.update', [$order->id]) }}"
                                            ...
                                            <td class="text-end">
                                                ...
                                                <form action="{{ route('back.orders.destroy', [$order->id]) }}"
                                                    method="get">
                                                    <button type="submit"
                                                        class="btn btn-sm font-sm btn-danger mt-1 rounded">

            ...
            <div class="row">
                <div class="col-9">
                    ...
                    <div class="content-header">
                        ...
                        <form action="{{ route('back.product.store') }}" method="post"
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div>
                                ...
                                <textarea placeholder="Type here" class="form-control @error('summary') is-invalid @enderror " rows="4" id="summary" name="summary"></textarea>
                                @error('summary')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                                    </span>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Type here" class="form-control @error('discounted_price') is-invalid @enderror " id="discounted_price" name="discounted_price">
